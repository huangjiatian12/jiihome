...
Page({
  ...
  addrInfo(addrId){
    ...
    wx.getStorage({
      ...
      success: function (res) {
        wx.request({
          url: app.globalData.api + '/Home/index/addrInfo',
          data: {
            userId: res.data.id,
            thr_session: res.data.thr_session,
            addrId: addrId,
          ...
          success: function (res1) {
            if (res1.data.info.status == '1'){
              var defaul = true
            }else{
              var defaul = false
            }
            self.setData({
              id: res1.data.info.id,
              name:res1.data.info.name,
              mobile: res1.data.info.mobile,
              city: res1.data.info.city,
              areaInfo: res1.data.info.city,
              address: res1.data.info.address,
              status: res1.data.info.status,
              defaul: defaul
            })
          }
        })
  ...
  delSure(){
    ...
    wx.getStorage({
      ...
      success: function (res) {
        wx.request({
          url: app.globalData.api + '/Home/index/delAddr',
          data: {
            userId: res.data.id,
            thr_session: res.data.thr_session,
            addrId: addrId,
